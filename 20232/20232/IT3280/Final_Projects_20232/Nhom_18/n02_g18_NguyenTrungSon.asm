...
.text
	...
	li	 $s3, 512		# SCREEN_WIDTH = 512 chieu rong man hinh
 	...
 	li	 $t7, 0			# dx = 0 gia tri dich chuyen theo chieu ngang tai thoi diem hien tai
 	li	 $t8, 0			# dy = 0 gia tri dich chuyen theo chieu doc tai thoi diem hien tai
...
#==========================================================================================
 ...
 ket_thuc:
 #----------------------------------------------------------------
 # tao ham lam cho chuong trinh dung chay trong 1 khoang th?i gian
...
.macro delay(%r)	
 	...
 	syscall
.end_macro
#tao ham de dat lai mau va ve them duong tron ? vi tri moi
...
.end_macro  
 ...
 phia_ben_phai:
 	...
 	add	 $v0, $v0,$t7		# neu x0 + R + khoang_cach > 512 thi nhay den ham di_sang_trai
 ...
 phia_ben_trai:
 	...
 	add	 $v0, $v0, $t7		# neu x0 - R + khoang_cach < 0 thi nhay den ham di_sang_phai
...
draw: 	
 	...
 	add	 $s0, $s0, $t7		# Cap nhat toa do x cua duong tron
...
sqrt: 
	...
	cvt.s.w	 $f1, $f1 		# chuyen gia tri cua f0 tuong duong voi gia tri so nguyen 32 bit
