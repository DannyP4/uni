...
is1:	beq	$v0, 1, ready  
is4:	beq	$v0, 4, ready
	j	error	#Kiem tra kich thuoc nhap vao, neu kh ng phai 1 hay 4 thi bao loi va yeu cau nhap lai
...
#3. Dia chi cua con tro
	...
	j	menu
#4. Vi?t h m th?c hi?n copy 2 con tr? x u k  t?.
case_2:
	bne	$v0, 2, case_3
	li	$v0, 4
	la	$a0, mess2.1
...
case_4:
	...
	syscall	
	j	menu
#6. Vi?t h m t nh to n b? l??ng b? nh? ?  c?p ph t.
case_5:
