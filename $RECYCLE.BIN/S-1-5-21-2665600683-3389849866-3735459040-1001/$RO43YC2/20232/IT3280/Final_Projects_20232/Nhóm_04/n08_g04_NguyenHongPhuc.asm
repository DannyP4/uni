.data
	...
	string: .space 5000
	enter: .asciiz "\n"
	error_length: .asciiz "Do dai chuoi khong chia het cho 8! Moi nhap lai.\n"
...
test_length: move $t5, $t3
	beq	$t5, 0, error1			# nếu độ dài chuỗi bằng 0 thì thông báo lỗi
...
print14:lb 	$t8, ($a2)
	...
	addi 	$t6, $t6, 1
	addi 	$a2, $a2, 4
	bgt 	$t6, 2, end1			# in ra 3 parity dau co dau ",", parity cuoi cung k co
	j 	print14	
end1:	lb 	$t8, ($a2)
	jal HEX
	li $v0, 4
